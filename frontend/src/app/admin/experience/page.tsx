    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="glass p-6 rounded-xl border border-border/50">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-xl">
          <input name="company" required type="text" placeholder="Company" className="p-3 rounded-md bg-background border border-border" />
          <input name="role" required type="text" placeholder="Role" className="p-3 rounded-md bg-background border border-border" />
          <input name="dateRange" required type="text" placeholder="Date Range" className="p-3 rounded-md bg-background border border-border" />
          <textarea name="description" required placeholder="Description" className="p-3 rounded-md bg-background border border-border" />
          <button type="submit" className="py-3 bg-primary text-primary-foreground font-bold rounded-md hover:opacity-90">Add Experience</button>
        </form>
      </div>
