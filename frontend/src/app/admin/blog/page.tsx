    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="glass p-6 rounded-xl border border-border/50">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-xl">
          <input name="title" required type="text" placeholder="title" className="p-3 rounded-md bg-background border border-border" />\n          <input name="snippet" required type="text" placeholder="snippet" className="p-3 rounded-md bg-background border border-border" />\n          <input name="url" required type="text" placeholder="url" className="p-3 rounded-md bg-background border border-border" />
          <button type="submit" className="py-3 bg-primary text-primary-foreground font-bold rounded-md hover:opacity-90">Add Blog</button>
        </form>
      </div>
